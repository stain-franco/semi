...
function Skills() {
  return (
    <>
    <h2 className='font-bold text-8xl mt-64 w-full text-center md:text-6xl md:mt-32 '>Ubicaciones Prioritarias</h2>
...
=======
        <Skill name="Marinilla" x="-6vw" y="-8vw"/>
>>>>>>> master
        <Skill name="Guarne" x="20vw" y="6vw"/>
        <Skill name="La Ceja" x="0vw" y="12vw"/>
        <Skill name="Medellin" x="-20vw" y="-15vw"/>
        <Skill name="El Santuario" x="15vw" y="-12vw"/>
        <Skill name="La Unión" x="20vw" y="20vw"/>
        <Skill name="Cocorná" x="32vw" y="-5vw"/>
        <Skill name="San Vicente" x="0vw" y="-20vw"/>
        <Skill name="El Retiro" x="-25vw" y="18vw"/>
    </div>
    </>
  )
}
