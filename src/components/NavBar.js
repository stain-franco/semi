  ...
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      <nav className='flex items-center justify-center flex-wrap'>
        <motion.a href="https://github.com/stain-franco" target={"_blank"}
        whileHover={{y:-4}}
        whileTap={{scale:0.9}}
        className="w-6 mx-3"
        >
        ...
        <motion.a href="https://www.linkedin.com/in/sebastian-franco-coronado-875320237/" target={"_blank"}
        whileHover={{y:-4}}
        whileTap={{scale:0.9}}
        className="w-6 ml-3"
        >
      ...
      <nav className='flex items-end flex-col justify-center' >
